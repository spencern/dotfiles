...
brew "planck" # Stand-alone ClojureScript REPL
...
brew "ctags" # A maintained ctags implementation
brew "delta" # Programatically minimize files to isolate features of interest
